            ...
            Expanded( child: Row(
              ...
              children: <Widget>[
                RaisedButton(
                  ...
                  child: Text('Heart', style: TextStyle(fontSize: 23),),
                  color: Colors.blue[600],
                  ),
                RaisedButton(
                  ...
                  child: Text('Fire', style: TextStyle(fontSize: 23),),
                  color: Colors.red[600],
                ),
                RaisedButton(
                  ...
                  child: Text('Skull', style: TextStyle(fontSize: 23),),
                  color: Colors.blue[600],
                  ),
              ],
            )),
            Expanded( child: Row(
              ...
              children: <Widget>[
                ...
                RaisedButton(
                  ...
                  child: Text('Punch', style: TextStyle(fontSize: 23),),
                  color: Colors.red[600],
                ),
                RaisedButton(
                  ...
                  child: Text('Dance', style: TextStyle(fontSize: 23),),
                  color: Colors.blue[600],
                  ),
              ],
            )),
